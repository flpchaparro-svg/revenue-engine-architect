          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 flex-1 content-center items-center">
            <div className="flex flex-col items-start max-w-3xl">
               ...
               <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.1] lg:leading-[0.9] tracking-tighter text-[#1a1a1a] mb-6 md:mb-10">
                 <span className="italic font-serif text-[#9A1730] drop-shadow-[0_0_20px_rgba(226,30,63,0.2)]">Automation.</span>
               </h1>
           ...
           <div className="flex min-h-[600px]">
              ...
              <div className="w-2/3 p-12 relative flex flex-col">
                  <AnimatePresence mode="wait">
                    ...
                    >
                       <div className="mb-10">
                          <span className="text-[#9A1730] font-mono text-[10px] uppercase tracking-widest font-bold mb-3 block">The Pain</span>
                               ...
                               <AnimatePresence>
                                 {isPersonaExpanded && (
                                   ...
                                   >
                                      <div className="p-6">
                                         <div className="mb-6">
                                            <span className="text-[#9A1730] font-mono text-[10px] uppercase tracking-widest font-bold mb-2 block">The Pain</span>
