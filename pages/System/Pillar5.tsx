          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 flex-1 content-center items-center">
            <div className="flex flex-col items-start max-w-3xl">
               ...
               <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.1] lg:leading-[0.9] tracking-tighter text-[#1a1a1a] mb-6 md:mb-10">
                 <span className="italic font-serif text-[#1a1a1a]">Content</span> <span className="italic font-serif text-[#8B6914] drop-shadow-[0_0_20px_rgba(197,160,89,0.2)]">Systems.</span>
               </h1>
           ...
           <div className="grid grid-cols-4 border-b border-black/10 bg-[#FAFAFA]">
              {Object.entries(TIERS).map(([key, tier]) => (
                ...
                >
                  ...
                  {activeTier === key && <m.div layoutId="tab-highlight" className="absolute top-0 left-0 w-full h-1 bg-[#C5A059]" />}
                </button>
              ))}
           </div>
                               ...
                               <AnimatePresence>
                                 {isPersonaExpanded && (
                                   ...
                                   >
                                      <div className="p-6">
                                         <div className="mb-6">
                                            <span className="text-[#8B6914] font-mono text-[9px] uppercase tracking-widest font-bold mb-2 block">The Problem</span>
