          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 flex-1 content-center items-center">
            <div className="flex flex-col items-start max-w-3xl">
               ...
               <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.1] lg:leading-[0.9] tracking-tighter text-dark mb-6 md:mb-10">
                 Pick Your <span className="italic font-serif text-red-solid drop-shadow-[0_0_20px_rgba(226,30,63,0.2)]">Situation.</span>
               </h1>
           ...
           <div className="flex min-h-[600px]">
              ...
              <div className="w-2/3 p-12 relative flex flex-col">
                  <AnimatePresence mode="wait">
                    ...
                    >
                       <div className="mb-10">
                          <span className="text-red-solid font-mono text-[10px] uppercase tracking-widest font-bold mb-3 block">The Problem</span>
                       ...
                       <div className="mt-auto bg-dark p-8 text-white rounded-sm relative overflow-hidden shadow-2xl">
                          ...
                          <div className="relative z-10 flex gap-8">
                             <div className="flex-grow">
                                <span className="font-mono text-[10px] text-red-solid uppercase tracking-widest block mb-4 font-bold">The Fix</span>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown className={`w-5 h-5 transition-transform duration-300 ${isTierExpanded ? 'rotate-180 text-red-solid' : 'text-black/60'}`} />
                </button>
                    ...
                    >
                      <div className="p-4 space-y-2">
                         <div className="mb-6 p-4 bg-white border border-black/5 rounded-sm">
                            <p className="font-sans text-sm text-black/70 leading-relaxed">
                               <strong className="text-red-solid block mb-1 font-bold uppercase text-[10px] tracking-widest">Is this you?</strong>
                               {tier.summary}
                            </p>
                         </div>
                         ...
                         {tier.personas.map((p) => {
                           ...
                           return (
                             <div 
                                ...
                                className={`border rounded-sm overflow-hidden transition-all duration-300 ${isPersonaExpanded ? 'border-red-solid bg-white shadow-md' : 'border-black/5 bg-white'}`}
                             >
                               <button 
                                 onClick={() => {
                               ...
                               <AnimatePresence>
                                 {isPersonaExpanded && (
                                   ...
                                   >
                                      <div className="p-6">
                                         <div className="mb-6">
                                            <span className="text-red-solid font-mono text-[10px] uppercase tracking-widest font-bold mb-2 block">The Problem</span>
                                         ...
                                         <div className="bg-dark p-6 text-white rounded-sm mb-6 relative overflow-hidden">
                                            ...
                                            <span className="font-mono text-[10px] text-red-solid uppercase tracking-widest block mb-3 font-bold relative z-10">The Fix</span>
