      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full flex-grow pb-32 relative z-10">
          ...
          <div className="bg-white border border-dark/5 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] p-0 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 border-b border-dark/5">
              <div className="lg:col-span-4 bg-gray-100 p-8 border-b lg:border-b-0 lg:border-r border-dark/5 space-y-8">
                ...
                <div>
                  <span className="font-mono text-xs font-bold text-dark/80 uppercase tracking-[0.2em] block mb-2">TIMELINE</span>
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4 text-gold-on-cream" />
        ...
        <Section className="mb-20 md:mb-32">
          <div className="mb-12">
            ...
            <div className="inline-flex items-center gap-3 px-4 py-2 bg-gold/5 border border-gold/20 rounded-sm">
               <span className="font-sans text-sm md:text-base font-medium text-dark/80">group7security.com.au</span>
               <span className="font-mono text-xs text-gold-muted uppercase tracking-[0.2em] font-bold">LIVE SYSTEM</span>
            </div>
          </div>
              ...
              <div key={i} className="relative pl-8 md:pl-16 group">
                ...
                <div className="bg-white p-8 border border-black/5 hover:border-gold/50 shadow-sm hover:shadow-xl transition-all duration-snap rounded-sm">
                  ...
                  <div className="bg-gray-100 p-5 border-l-2 border-gold">
                    ...
                    <p className="font-sans text-base md:text-lg text-dark/80 leading-relaxed">
                      {item.why}
                    </p>
                  </div>
                </div>
              ...
              <div key={i} className="bg-white p-8 border border-dark/5 hover:border-gold transition-all duration-snap group shadow-sm flex flex-col justify-between min-h-[280px] h-auto">
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex items-baseline gap-1 mb-2">
                    ...
                    <span className={`text-xl font-serif ${m.color === 'text-green-600' ? 'text-green-600' : 'text-gold-on-cream'}`}>{m.suffix}</span>
                  </div>
                  <div className="flex items-center gap-2 border-t border-dark/5 pt-4 mt-2">
                    <div className={`w-1.5 h-1.5 rounded-full ${m.color === 'text-green-600' ? 'bg-green-500' : 'bg-gold'}`} />
        ...
        <Section className="mb-20 md:mb-32">
           <div className="mb-12">
            ...
            <h2 className="font-serif text-4xl md:text-5xl lg:text-7xl leading-[0.95] tracking-tighter text-dark mb-8">
              Before & <span className="italic font-serif text-gold-on-cream">After.</span>
            </h2>
          </div>
          
          <div className="bg-white p-4 border border-dark/10 shadow-2xl rounded-sm">
