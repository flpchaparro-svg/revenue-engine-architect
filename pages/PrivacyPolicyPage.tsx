...
const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({ onBack, onNavigate }) => {
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }} 
      exit={{ opacity: 0 }}
      className="min-h-screen bg-[#FFF2EC] text-[#1a1a1a] font-sans selection:bg-[#C5A059]/30"
    >
      <div className="max-w-[1000px] mx-auto px-6 md:px-12 lg:px-20 pt-24 pb-32">
        ...
        <div className="mb-24 border-b border-[#1a1a1a]/10 pb-12">
           ...
           <h1 className="font-serif text-5xl md:text-7xl leading-[0.9] tracking-tighter text-[#1a1a1a]">
             Privacy <span className="italic font-serif text-[#C5A059]">Policy.</span>
           </h1>
           <p className="mt-8 font-sans text-lg text-[#1a1a1a]/60 max-w-2xl">
        ...
        <div className="space-y-16 max-w-3xl">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2 font-sans text-base text-[#1a1a1a]/70">
