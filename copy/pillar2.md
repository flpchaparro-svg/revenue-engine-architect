...
## Tiers & personas
- **Source:** `constants/pillar2Data.ts` — TIERS: CAPTURE ("I keep losing leads.", 7 DAYS), NURTURE ("My leads go cold.", 14 DAYS), PIPELINE ("I can't see my deals.", 14 DAYS), REVOPS ("I need everything connected.", 21 DAYS). Personas and copy as in data file.
